...
@Component
public class AboutUsMessageHandler implements InputMessageHandler{
    private MainMenuService mainMenuService;
    private ReplyMessageService messagesService;

    public AboutUsMessageHandler(MainMenuService mainMenuService, ReplyMessageService messagesService) {
    ...
    public SendMessage handle(Message message) {
        return mainMenuService.getMainMenuMessage(message.getChatId(),
                messagesService.getReplyText("reply.showAboutUsMessage"));
    }

    @Override
    public BotState getHandlerName() {
        return BotState.SHOW_ABOUT_US_MESSAGE;
    }
}
