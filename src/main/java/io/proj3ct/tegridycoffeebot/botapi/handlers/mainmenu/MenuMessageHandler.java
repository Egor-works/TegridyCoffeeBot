...
public class MenuMessageHandler implements InputMessageHandler{
    ...
    public MenuMessageHandler(MainMenuService mainMenuService, ReplyMessageService messagesService) {
    ...
    public SendMessage handle(Message message) {
        return mainMenuService.getMainMenuMessage(message.getChatId(),
                messagesService.getReplyText("reply.showMenuMessage"));
    }

    @Override
    public BotState getHandlerName() {
        return BotState.SHOW_MENU_MESSAGE;
    }
}
